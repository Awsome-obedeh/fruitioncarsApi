...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $allowedFields = ["title", "description", "price", "image_url","car_gallery","category", "brand_name", "model", "year", "fuel_type", "color"];
    $setFields = [];
    $params = [];
    ...
    $sql = "UPDATE carlisting  SET " . implode(", ", $setFields) . " WHERE id = :id";
